...
-- Add posts constraints if they don't exist
DO $$ 
BEGIN
...
-- Add tags constraints if they don't exist
DO $$ 
BEGIN
...
-- Drop existing posts policies if they exist
...
-- Drop existing tags policies if they exist
...
-- Drop existing post_tags policies if they exist
